...
public class DefaultRedoHandler extends ApplicationObjectSupport implements RedoHandler {
    ...
    public void redo(SysRedo redoItem) {
        ...
        Method m = null;
        try {
            m = bizClazz.getMethod(redoItem.getBizInvokeMethod(), methodArgTypes);
        } catch (Exception e) {
     ...
     *
     * @see com.xxx.redo.service.RedoService#serialize(Object[])
    ...
    public static void main(String[] args) throws ClassNotFoundException {
        ...
        // test complex array
        typeStr = "[Lcom.xxx.redo.model.SysRedo;";
        clazz = Class.forName(typeStr);
        data = "[{\"id\":1},{\"id\":2}]";
        object = JsonUtil.toArray(data, clazz);
        System.out.println(object);
        ...
        Class[] type = JsonUtil.toRawType("[\"[Lcom.xxx.redo.model.SysRedo;\"]");
